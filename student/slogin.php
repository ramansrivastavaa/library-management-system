...
<div class="login_wrapper">
    ...
    <section class="login_content">
        <form name="form1" action="slogcode.php" method="post">
            ...
            <div>
                ...
                <input class="btn btn-default submit" type="submit" name="submit1" value="Login">
                  <a href="../index.php" class="btn btn-default submit" style="height:35px;font-family:Bahnschrift;">Admin login</a>
  ...
  <a href="register.php" class="btn btn-primary">new student? register here</a>
